...
class CurryTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      $curries = [
  ['id' => '1', 'curry_name' => 'バナナの焼きカレー', 'price' => '850', 'shop_id' => '1', 'curry_type' => '4', 'main_ingredient' => '7', 'calorie' => null, 'allergies' => null, 'hot_rate' => null, 'topping' => null, 'amount' => '1', 'naan_rice' => '1', ],
  ['id' => '2', 'curry_name' => 'シーフードと彩り野菜のタイ風グリーンカレー', 'price' => '1190', 'shop_id' => '2', 'curry_type' => '5', 'main_ingredient' => '5', 'calorie' => null, 'allergies' => null, 'hot_rate' => null, 'topping' => null, 'amount' => '0', 'naan_rice' => '1', ],
  ['id' => '3', 'curry_name' => '昔の焼きカレー', 'price' => '950', 'shop_id' => '1', 'curry_type' => '4', 'main_ingredient' => '2', 'calorie' => null, 'allergies' => null, 'hot_rate' => null, 'topping' => null, 'amount' => '1', 'naan_rice' => '1', ],
  ['id' => '4', 'curry_name' => '朝のスパイシーチキンカレー', 'price' => '690', 'shop_id' => '2', 'curry_type' => '1', 'main_ingredient' => '1', 'calorie' => null, 'allergies' => null, 'hot_rate' => null, 'topping' => null, 'amount' => '0', 'naan_rice' => '1', ],
  ['id' => '5', 'curry_name' => 'シーフードの焼きカレー', 'price' => '1050', 'shop_id' => '1', 'curry_type' => '4', 'main_ingredient' => '5', 'calorie' => null, 'allergies' => null, 'hot_rate' => null, 'topping' => null, 'amount' => '1', 'naan_rice' => '1', ],
  ['id' => '6', 'curry_name' => '1日分の野菜カレー', 'price' => '990', 'shop_id' => '2', 'curry_type' => '3', 'main_ingredient' => '6', 'calorie' => null, 'allergies' => null, 'hot_rate' => null, 'topping' => null, 'amount' => '0', 'naan_rice' => '1', ],
